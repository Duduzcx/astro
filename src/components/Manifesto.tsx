...
import { TextoQueAcende } from './ui/TextoQueAcende'
        ...
        <div className="shell">
          <BlurReveal className="mx-auto max-w-4xl">
            {/* O destaque não é mais uma cor aplicada a meia frase: é a
                própria leitura acendendo enquanto a pessoa rola. */}
            <TextoQueAcende className="text-center text-[clamp(1.7rem,3.6vw,2.9rem)] leading-[1.25] font-[480] tracking-[-0.01em]">
              Hoje o seu negócio funciona na base de planilha, papel e memória. A gente troca
              isso por um sistema que trabalha sozinho.
            </TextoQueAcende>
          </BlurReveal>
        </div>
      </div>
