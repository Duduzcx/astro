...
export function Practices() {
  return (
    <section className="relative flex min-h-[100svh] flex-col justify-center py-24">
      <div className="shell grid gap-10 lg:grid-cols-2 lg:items-end">
        ...
        >
          <Label>Figura 02 — Constelação</Label>
        ...
        <motion.p
          ...
          className="max-w-md text-[clamp(1.05rem,1.6vw,1.35rem)] leading-[1.26] text-mist lg:justify-self-end"
        >
