...
const KEYFRAMES: Array<[number, number, number, number, number, number]> = [
  ...
  [0.215, 0.85, 0.0, 0.0, 1.25, 0.35],
  [0.245, 1.0, 0.0, 0.0, 1.12, 0.9],
  [0.275, 1.0, 0.0, 0.0, 1.12, 0.9],
  [0.295, 1.0, 0.0, 0.0, 1.12, 0.0],
  [0.315, 0.3, 0.55, 0.0, 0.9, 0.0],
  [0.335, 0.05, 0.55, 0.0, 0.9, 1.0],
  [0.365, 0.06, 0.55, 0.0, 0.9, 1.0],
  [0.4, 0.9, 0.0, 0.0, 1.35, 0.22],
  [0.425, 0.9, 0.0, 0.0, 1.35, 0.22],
  [0.445, 0.9, 0.0, 0.0, 1.35, 0.0],
  [0.475, 0.9, 0.0, 0.0, 1.35, 0.0],
  [0.505, 0.9, 0.0, 0.0, 1.35, 0.22],
