...
export function AuroraBlobs() {
  return (
    <div aria-hidden="true" className="fixed inset-0 z-0 overflow-hidden">
      ...
      <div className="absolute right-[-6%] bottom-[6%] h-[42vh] w-[38vw] animate-[astro-blob-b_31s_ease-in-out_infinite] rounded-full bg-[#c9a0ff]/10 blur-[130px]" />
      <div className="absolute top-[38%] left-[52%] h-[36vh] w-[30vw] animate-[astro-blob-a_37s_ease-in-out_infinite_reverse] rounded-full bg-[#b57aff]/12 blur-[130px]" />
    </div>
  )
}
