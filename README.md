...
**Medições.** Rolagem automatizada em passos de 14px, segunda passada, frames acima de 24ms. 13/09/2026, com estrelas, foguete, planeta com shader e buraco negro — 400px 0,06% (p95 16,8ms, pior 33ms), 1280px 1,5% (p95 16,9ms, pior 50ms). Fase 2 (sem o buraco negro): 0% e 1,0%. Fase 1 (só estrelas e foguete): 0,06% e 2,4%. Antes da cena espacial: 0% e 12%.
