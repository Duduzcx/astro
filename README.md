...
**Medições.** Rolagem automatizada em passos de 14px, segunda passada, frames acima de 24ms. 13/09/2026, com estrelas, foguete e planeta com shader — 400px 0% (p95 16,8ms, pior 17ms), 1280px 1,0% (p95 16,9ms, pior 83ms). Fase 1 (só estrelas e foguete): 0,06% e 2,4%. Antes da cena espacial: 0% e 12%.
